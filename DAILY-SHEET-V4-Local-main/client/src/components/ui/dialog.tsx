  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed left-[50%] top-[50%] z-50 grid w-[calc(100vw-2rem)] max-w-lg gap-4 border border-white/10 bg-card/90 backdrop-blur-2xl p-4 sm:p-6 shadow-2xl duration-200 rounded-2xl overflow-clip",
